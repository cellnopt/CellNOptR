gaBinaryT1 <-
function(CNOlist,Model,SimList,indexList,sizeFac=0.0001,NAFac=1,initBstring,PopSize=50,Pmutation=0.5,MaxTime=60,maxGens=500,StallGenMax=100,SelPress=1.2,elitism=5, RelTol=0.1, verbose=TRUE){
#initialise
...
#Function that produces the score for a specific bitstring
	...
	#Compute the score	
		Score<-GetFit(SimResults=SimResults,CNOlist=CNOlist,Model=ModelCut,indexList=indexList,timePoint="t1",sizeFac=sizeFac,NAFac=NAFac)
