...
# 
# $Id: gaBinaryDelay.R 4535 2014-04-23 12:07:41Z aidanmac $

gaBinaryDelay <- function(CNOlist, model, initBstring = NULL, sizeFac = 1e-04, NAFac = 1, popSize = 50, pMutation = 0.5, maxTime = 60, maxGens = 500, stallGenMax = 100, 
    selPress = 1.2, elitism = 5, relTol = 0.1, verbose = TRUE, priorBitString = NULL, maxSizeHashTable = 5000, boolUpdates) {
    ...
    getObj <- function(x, scoresHash = NULL) {
        ...
        Score = computeScoreDelay(CNOlist, model, bitString, simList, indexList, sizeFac, NAFac, boolUpdates)
