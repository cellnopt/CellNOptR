...
#
##############################################################################
# $Id: cutAndPlotResultsDelay.R 4527 2014-04-14 08:58:25Z aidanmac $

cutAndPlotResultsDelay <- function(model, bString, simList=NULL, CNOlist, indexList=NULL,
 plotPDF=FALSE, tag=NULL, plotParams=list(maxrow=10),boolUpdates=boolUpdates, sizeFac = 1e-04, NAFac = 1)
{
